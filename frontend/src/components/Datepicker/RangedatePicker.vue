  ...
  <div class="calendar-root">
    ...
    <div class="calendar" :class="{'calendar-mobile ': isCompact, 'calendar-right-to-left': isRighttoLeft}" v-if="isOpen">
      <div class="calendar-head" v-if="!isCompact">
        <h2 style="font-size: 20px;">{{captions.title}}</h2>
        <i class="close" @click="toggleCalendar()">&times</i>
      </div>
      <div style="display: flex">
      <div class="calendar-wrap" v-show="showWrapper" style="width: auto !important; display: flex;">
        <div class="calendar_month_left" style="width: 220px;" :class="{'calendar-left-mobile': isCompact}" v-if="showMonth">
        ...
        <div style="width: 220px;" class="calendar_month_right" v-if="!isCompact">
          <div class="months-text">
      ...
      <div class="calendar-range" style="width: 272px !important; margin-top: 5px;" :class="{'calendar-range-mobile ': isCompact}" v-if="!showMonth || !isCompact">
        <ul class="calendar_preset">
          ...
          <li><button class="calendar-btn-apply" style="background-image: linear-gradient(241deg, #37aee2, #1e96c8); font-size: 16px !important; font-weight: 500; font-family: Roboto; border-radius: 6px" @click="setDateValue()">{{captions.ok_button}}</button></li>
        </ul>
      </div>
      </div>
    </div>
